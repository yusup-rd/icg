...
import { DateOfBirthPicker } from "@/components/Dropdown/DateOfBirthPicker";
import { countryCodes } from "@/data/countryCodeData";
import { differenceInYears } from "date-fns";
import AlternateSignIn from "../AlternateSignIn";
import { useTranslations } from "next-intl";
import { AnimatePresence, motion } from "framer-motion";
import { modalMotion, motionVariants } from "@/utils/framerUtil";
...
const RegisterModal = () => {
  ...
  return (
    <div className="container mt-5 flex items-center justify-center md:mt-10">
      <AnimatePresence>
        <motion.div
          className="flex h-screen max-h-[70vh] flex-col rounded-lg border bg-white shadow-lg md:h-auto md:max-h-[80vh] md:w-8/12 lg:w-6/12"
          key="modal"
          {...motionVariants}
