...
const LoginPage = () => {
  ...
  return (
    <div className="container -my-12 flex h-screen items-center justify-center md:mb-0">
      <AnimatePresence>
        <motion.div
          className="flex flex-col rounded-lg border bg-white shadow-lg md:max-h-[90vh] md:w-8/12 lg:w-6/12"
          key="modal"
          {...motionVariants}
