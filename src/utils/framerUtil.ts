...
export const modalMotion = {
  hidden: { scale: 0.95, transition: { duration: 0.1, ease: "easeInOut" } },
  visible: { scale: 1, transition: { duration: 0.1, ease: "easeInOut" } },
  exit: { scale: 0.95, transition: { duration: 0.1, ease: "easeInOut" } },
};
